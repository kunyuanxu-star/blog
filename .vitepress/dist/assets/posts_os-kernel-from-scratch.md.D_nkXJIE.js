...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">make</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> run</span></span></code></pre></div><h2 id="下一步" tabindex="-1">下一步 <a class="header-anchor" href="#下一步" aria-label="Permalink to &quot;下一步&quot;">​</a></h2><p>现在你有了一个最简单的操作系统内核！接下来可以：</p><ul><li>🔧 实现中断处理（IDT）</li><li>💾 添加内存管理</li><li>⌨️ 实现键盘驱动</li><li>📟 实现简单的 Shell</li></ul><h2 id="参考资源" tabindex="-1">参考资源 <a class="header-anchor" href="#参考资源" aria-label="Permalink to &quot;参考资源&quot;">​</a></h2><ul><li><a href="https://wiki.osdev.org/" target="_blank" rel="noreferrer">OSDev Wiki</a></li><li><a href="https://www.cs.bham.ac.uk/~exr/lectures/opsys/10_11/lectures/os-dev.pdf" target="_blank" rel="noreferrer">Writing a Simple Operating System from Scratch</a></li><li><a href="https://littleosbook.github.io/" target="_blank" rel="noreferrer">The little book about OS development</a></li></ul><hr><p>这就是操作系统开发的第一步！🚀</p>`,28)])])}const g=a(l,[["render",e]]);export{o as __pageData,g as default};
